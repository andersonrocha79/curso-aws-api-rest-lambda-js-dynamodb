...
// faz a geração de dados aleatórios incluirmos na tabela do dynamo para testes
...
const fixtureFile = path.normalize (path.join(__dirname, '../', 'migrations', 'pacientes-seed.json'))
